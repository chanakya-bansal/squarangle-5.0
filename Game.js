...
back=Matter.Bodies.circle(50,50,20,{
    render: { 
        sprite:{ 
            texture: 'back.png'
        }
...
///// 580 2650, 530 2650, 1080 2200--------------------1060 2510, 280 2460, 1420 2640
...
if(counter>=450){
  ...
  if(render.bounds.max.y==1398){
    ...
    Matter.World.add(engine.world,[back,resetBtn])
    Matter.Body.setPosition(back,{x:1450,y:1350})
...
Matter.World.add(engine.world,[back,resetBtn])
Matter.Body.setPosition(back,{x:1450,y:2075})
...
Matter.World.add(engine.world,[back,resetBtn])
Matter.Body.setPosition(back,{x:1450,y:2750})
Matter.Body.setPosition(resetBtn,{x:1350,y:2750})
  ...
  if(counter_4>=450){
    ...
    if(render.bounds.max.y==3498){
     ...
     Matter.World.add(engine.world,[back,resetBtn])
Matter.Body.setPosition(back,{x:1050,y:2850})
